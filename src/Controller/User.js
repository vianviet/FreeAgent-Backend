const { authenticateService, findAllService, findOneService, updateService, deleteService, registerService } = require("../Service/User");
...
module.exports = { authenticateController, findAllController, findOneController, updateController, deleteController, registerController }