const { findUser, findAllRepo, AddUser, findByUserName, findByEmail, deleteOne, updateOne, findOne } = require("../Repository/User")
...
module.exports = { authenticateService, findAllService, registerService, updateService, deleteService, findOneService }